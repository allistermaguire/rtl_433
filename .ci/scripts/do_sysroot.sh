...
then
    ...
    cmake -DCMAKE_TOOLCHAIN_FILE=$source_dir/cmake/Toolchain-gcc-mingw-w64-i686.cmake -B build-tmp && cmake --build build-tmp && cmake --install build-tmp
    rm -rf build-tmp
...
then
    ...
    cmake -DCMAKE_TOOLCHAIN_FILE=$source_dir/cmake/Toolchain-gcc-mingw-w64-i686.cmake -DBUILD_SHARED_LIBS:BOOL=OFF -B build-tmp && cmake --build build-tmp && cmake --install build-tmp
    rm -rf build-tmp
...
then
    ...
    cmake -DCMAKE_TOOLCHAIN_FILE=$source_dir/cmake/Toolchain-gcc-mingw-w64-x86-64.cmake -B build-tmp && cmake --build build-tmp && cmake --install build-tmp
    rm -rf build-tmp
...
then
    ...
    cmake -DCMAKE_TOOLCHAIN_FILE=$source_dir/cmake/Toolchain-gcc-mingw-w64-x86-64.cmake -DBUILD_SHARED_LIBS:BOOL=OFF -B build-tmp && cmake --build build-tmp && cmake --install build-tmp
    rm -rf build-tmp
